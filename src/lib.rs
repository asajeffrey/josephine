...
//! `JSTraceable`, and similarly for `JSRootable` and `JSCompartmental`. This requirement
...
//! # use josephine::*;
//! #[derive(JSInitializable, JSTraceable, JSRootable, JSCompartmental)]
//! struct NativeName { name: String }
//!
//! #[derive(Clone, Copy, Debug, Eq, PartialEq, JSInitializable, JSTraceable, JSRootable, JSCompartmental)]
...
//!
//! #[derive(Clone, Copy, Debug, JSInitializable, JSTraceable, JSRootable, JSCompartmental)]
